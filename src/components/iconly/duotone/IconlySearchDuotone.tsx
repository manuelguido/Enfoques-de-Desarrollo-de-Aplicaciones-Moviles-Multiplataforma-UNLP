...
export const IconlySearchDuotone = ({ size = 24, color = "#000000" }: IconlyIconProps) => {
	return (
		<Svg width={size} height={size} viewBox="0 0 25 24" fill="none">
			...
			<Path opacity="0.4" d="M17.8604 17.584L21.2853 21.0002" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"></Path>
			<Path opacity="0.4" d="M13.832 6.74072C15.2302 7.16593 16.3356 8.25375 16.7841 9.64029" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"></Path>
		</Svg>
	);
};
